...
Enunciado: Crie um programa que leia continuamente números inteiros positivos fornecidos pelo 
usuário. A leitura deve ser encerrada imediatamente quando o usuário digitar um número negativo 
(flag de parada). Ao final, o programa deve exibir a quantidade de números digitados, a soma 
total e a média aritmética deles (desconsiderando o valor negativo).
