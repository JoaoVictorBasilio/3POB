...
Enunciado: Desenvolva um programa que leia uma matriz quadrada de ordem 4 (4 x 4) de números reais (double). O programa deve 
calcular e exibir a soma de todos os elementos que pertencem à diagonal principal (onde o índice da linha é igual ao índice da 
coluna: i == j).
