...
Enunciado: Crie um programa que leia uma matriz A de dimensão 2 x 3 de números inteiros. Em seguida, construa e exiba a sua matriz 
transposta A^ de dimensão 3 x 2 (onde o elemento da posição [i][j] em A passa a ocupar a posição [j][i] em A^).
